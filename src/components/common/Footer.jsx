...
const Footer = () => {
    return (
        <div className='bg-gray lg:pt-[125.1px] pt-17 pb-40 lg:pb-[263.1px]'>
                ...
                <div className='flex flex-row flex-wrap justify-center mt-5 lg:mt-20.75 gap-10 md:gap-[63.1px]'>
                    {FOOTER_LINKS.map((item, index) => {
                        return (
                            <div key={index}>
                                <Link href="/"
                                className='text-xl font-medium text-black leading-100 hover:underline duration-500 hover:text-red-500'>
                                    {item}
                                </Link>
                            </div>
                        )
